...
do 
 echo "$patient"
 touch /group/p00259/structural/$patient/hipp_manseg_r.txt
 touch /group/p00259/structural/$patient/hipp_manseg_l.txt
 
 fslstats /group/p00259/structural/$patient/*/hipp_manseg_r.nii.gz -V >> /group/p00259/structural/$patient/hipp_manseg_r.txt
 fslstats /group/p00259/structural/$patient/*/hipp_manseg_l.nii.gz -V >> /group/p00259/structural/$patient/hipp_manseg_l.txt
