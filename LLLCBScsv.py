...
save = "/scratch/hphi/mkp42/Hippocampus/"
basepath = "/group/p00259/structural/"
path1 = "hipp_manseg_r.txt"
path2 = "hipp_manseg_l.txt"



for patient in patients:
    try:
        f1 = open(basepath + str(patient) +  path1 , "r")
        content1 = f1.read()
        f1.close()
        f2 = open(basepath + str(patient) +  path2 , "r")
        content2 = f2.read()
        f2.close()
        ...
        print(row)
        with open(save + 'LLLCBSvolumes.csv', 'a') as file:
